...
```shell
go install github.com/mertcikla/GoSNMPServer/cmd/gosnmpserver
...
import "github.com/mertcikla/GoSNMPServer"
import "github.com/mertcikla/GoSNMPServer/mibImps"
```
...
Serve your own oids
-----
This library provides some common oid for use. See [mibImps](https://github.com/mertcikla/GoSNMPServer/tree/master/mibImps) for code, See [![GoDoc](https://godoc.org/github.com/mertcikla/GoSNMPServe/mibImpsr?status.png)](https://godoc.org/github.com/mertcikla/GoSNMPServer/mibImps) here.
